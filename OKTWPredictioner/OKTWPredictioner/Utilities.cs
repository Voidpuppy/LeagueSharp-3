...
namespace OKTWPredictioner
{
    ...
    {
        public static string[] lowPriority = new string[]
        {
            "Alistar",
            "Amumu",
            "Bard",
        ...
        public static string[] mediumPriority = new string[]
        {
            "Aatrox",
            "Akali",
            "Darius",
        ...
        public static string[] highPriority = new string[]
        {
            "Ahri",
            "Anivia",
            "Annie",
        ...
        public static string[] HitchanceNameArray = new string[]
        {
            "Low",
            "Medium",
            "High",
